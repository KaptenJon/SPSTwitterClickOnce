...
namespace TwitterHost
{
    ...
    public class Service1 : IService1
    {
        ...
        private InstagramConfig _instagramConfig;
        private OAuth _instagramOAuth;
        private OAuthResponse _instagramResponce;
        private string _InstagramClientSecret = "3af796822e774b20b38dcb3871ccfd28";
        ...
        public Service1()
        {
            ...
            if (_tokens == null)
            {
                ...
                //_instagramConfig.RedirectUri = @"http://sharpednet.se";
